...
import { Ref } from 'vue';
import { API_EXTENSION_PACKAGE_TYPES, API_EXTENSION_TYPES, API_WITHOUT_HYBRID_EXTENSION_TYPES, APP_EXTENSION_PACKAGE_TYPES, APP_EXTENSION_TYPES, APP_WITHOUT_HYBRID_EXTENSION_TYPES, EXTENSION_PACKAGE_TYPES, EXTENSION_PKG_KEY, EXTENSION_TYPES, HYBRID_EXTENSION_TYPES, LOCAL_TYPES, PACK_EXTENSION_TYPE } from '../constants';
...
export declare type AppWithoutHybridExtensionType = typeof APP_WITHOUT_HYBRID_EXTENSION_TYPES[number];
export declare type ApiWithoutHybridExtensionType = typeof API_WITHOUT_HYBRID_EXTENSION_TYPES[number];
...
export declare type PackExtensionType = typeof PACK_EXTENSION_TYPE;
...
declare type PackExtensionCommon = {
...
export declare type ExtensionPackage = ExtensionPackageCommon & (AppExtensionCommon | ApiExtensionCommon | HybridExtensionCommon | PackExtensionCommon);
...
declare type ExtensionManifestCommon = {
    host: string;
    hidden?: boolean;
};
declare type ExtensionManifestWithoutHybrid = {
    type: AppWithoutHybridExtensionType | ApiWithoutHybridExtensionType;
    path: string;
    source: string;
};
declare type ExtensionManifestHybrid = {
    type: HybridExtensionType;
    path: {
        app: string;
        api: string;
...
declare type ExtensionManifestPack = {
    type: PackExtensionType;
};
export declare type ExtensionOptions = ExtensionManifestCommon & (ExtensionManifestWithoutHybrid | ExtensionManifestHybrid | ExtensionManifestPack);
